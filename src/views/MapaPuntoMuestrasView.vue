      ...
      <CardBox class="mb-6" has-table>
          ...
          <div class="flex flex-col items-center justify-center">
              ...
              <div style="height:600px; width: 95%" >
                  <l-map ref="map" v-model:zoom="zoom" :center="[39.54982998070428, -0.4656852311920545]" :use-global-leaflet="false">
                      <l-tile-layer
                  ...
                  <div v-for="punto in plantasStore.getPuntosMuestreo" :key="punto.id">
                      ...
                      <l-marker  v-if="punto.posicion" :lat-lng="[punto.posicion.lat,punto.posicion.lon]" >
                          <l-tooltip>
                              <div class="text-center">
                            ...
                            <l-popup>
                                <div class="text-center">
                                    ...
                                    <!-- <a href="http://google.com" target="_blank" class="text-sm">Ver en Google Maps</a> -->
                                    <p class="text-sm">id: {{ punto.id }}</p>
                                    <BaseButton label="Añadir analítica" color="info" @click="crearAnalitica(punto.id)"></BaseButton>
                                </div>
                            </l-popup>
                        </l-marker>
                    </div>
