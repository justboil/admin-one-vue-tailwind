...
watch(route, () => {getContent(); console.log("we're getting content using this route: ", route.path)})

async function getContent() {

    try {
      const response = await axios.get(`api/${route.params.asideMenuCategoria}`)

      if (response.statusText = "OK") {

        tableContent.value = response.data
        console.log("table content:", tableContent.value)
